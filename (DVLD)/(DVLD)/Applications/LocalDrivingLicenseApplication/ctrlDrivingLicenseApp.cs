...
namespace _DVLD_.Applications.LocalDrivingLicenseApplication
{
    public partial class ctrlDrivingLicenseApp : UserControl
    {
        ...
        {
            _LocalDrivingLicenseApplication = clsLocalDrivingLicenseApplicaionBusiness.FindByLocalDrivingAppLicenseID(LocalDrivingLicenseApplicationID);
        ...
        {
            _LocalDrivingLicenseApplication = clsLocalDrivingLicenseApplicaionBusiness.FindByApplicationID(ApplicationID);
            if (_LocalDrivingLicenseApplication == null)
            {
                _ResetLocalDrivingLicenseApplicationInfo();
        ...
        private void _FillLocalDrivingLicenseApplicationInfo()
        {
            ...
            ctlAppBaseInfo1.LoadApplicationInfo(_LocalDrivingLicenseApplication.ApplicationId);
