...
namespace DVLD_Buisness
{
    public class clsBusinessTest
    {
        ...
        public clsBussinessLayerTestAppointment TestAppointmentInfo { set; get; }
        ...
        public clsBusinessTest(int TestID,int TestAppointmentID,
            bool TestResult, string Notes, int CreatedByUserID)

        {
            this.TestID = TestID;
            this.TestAppointmentID = TestAppointmentID;
            this.TestAppointmentInfo = clsBussinessLayerTestAppointment.Find(TestAppointmentID);
        ...
        public static clsBusinessTest Find(int TestID)
        {
            ...
            ref  Notes, ref  CreatedByUserID))
                ...
                return new clsBusinessTest(TestID,
        ...
        public static clsBusinessTest FindLastTestPerPersonAndLicenseClass
