...
namespace DVLD_Buisness
{
    public class clsInternationalLicense: clsApplication
    {
...

        {
            ...
            this.AppType = (int)clsApplication.enApplicationType.NewInternationalLicense;
...

        {
            ...
            base.AppPersoneId = ApplicantPersonID;
            base.AppDate = ApplicationDate;
            base.AppType = (int)clsApplication.enApplicationType.NewInternationalLicense;
