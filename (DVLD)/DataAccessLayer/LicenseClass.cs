    ...
    public class clsLicenseClassData
    {
        public static bool GetLicenseClassInfoByID(int LicenseClassID, 
            ...
            ref byte DefaultValidityLength, ref float ClassFees)
            {
                ...
                string query = "SELECT * FROM LicenceClasses WHERE LicenceClassID = @LicenseClassID";
           ...
           ref byte DefaultValidityLength, ref float ClassFees)
        {
            ...
            string query = "SELECT * FROM LicenceClasses WHERE ClassName = @ClassName";
        ...
        public static DataTable GetAllLicenseClasses()
            {
                ...
                string query = "SELECT * FROM LicenceClasses order by ClassName";
            ...
            byte MinimumAllowedAge,byte DefaultValidityLength, float ClassFees)
        {
            ...
            string query = @"Insert Into LicenceClasses 
           (
            ...
            @ClassName,@ClassDescription,@MinimumAllowedAge, 
            @DefaultValidityLength,@ClassFees)
                            where LicenceClassID = @LicenseClassID;
            ...
            byte MinimumAllowedAge, byte DefaultValidityLength, float ClassFees)
        {
            ...
            string query = @"Update  LicenceClasses  
                            set ClassName = @ClassName,
                                ClassDescription = @ClassDescription,
                                MinimumAllowedAge = @MinimumAllowedAge,
                                DefaultValidityLength = @DefaultValidityLength,
                                ClassFees = @ClassFees
                                where LicenceClassID = @LicenceClassID";
