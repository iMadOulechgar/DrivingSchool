    ...
    public class clsLocalDrivingLicenseApplicationData
    {
        ...
        public static bool GetLocalDrivingLicenseApplicationInfoByID(
            ...
            ref int LicenseClassID)
            {
                ...
                string query = "SELECT * FROM LocalDrivingLicenceApplications WHERE LocalDrivingLicenceApplicationID = @LocalDrivingLicenceApplicationID";
         ...
         ref int LicenseClassID)
        {
            ...
            string query = "SELECT * FROM LocalDrivingLicenceApplications WHERE ApplicationID = @ApplicationID";
            ...
            int ApplicationID, int LicenseClassID )
        {
            ...
            string query = @"INSERT INTO LocalDrivingLicenceApplications ( 
                            ApplicationID,LicenceClassID)
            ...
            int LocalDrivingLicenseApplicationID, int ApplicationID, int LicenseClassID)
        {
            ...
            string query = @"Update  LocalDrivingLicenceApplications  
                            set ApplicationID = @ApplicationID,
                                LicenceClassID = @LicenseClassID
                            where LocalDrivingLicenceApplicationID=@LocalDrivingLicenseApplicationID";
        ...
        public static bool DeleteLocalDrivingLicenseApplication(int LocalDrivingLicenseApplicationID)
        {
            ...
            string query = @"Delete LocalDrivingLicenceApplications 
                                where LocalDrivingLicenceApplicationID = @LocalDrivingLicenseApplicationID";
...

        {
            ...
            string query = @" SELECT top 1 TestResult
                            ...
                            WHERE
                            (LocalDrivingLicenceApplications.LocalDrivingLicenceApplicationID = @LocalDrivingLicenceApplicationID) 
